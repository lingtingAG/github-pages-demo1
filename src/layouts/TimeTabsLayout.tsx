import { defineComponent, ref, reactive, watchEffect, Component, PropType, DefineComponent } from 'vue';
      ...
      <MainLayout>{
        {
          ...
          default: () => (
            <>
              <Tabs v-model:selected={refSelected.value} classPrefix="lt" onUpdate:selected={onSelect}>
              <Tab name="本月">
